                    ...
                    <tbody class="divide-y divide-gray-100">
                        @foreach ($this->requests as $req)
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3 font-medium text-gray-800">{{ $req->leaveType->code }}</td>
                                <td class="px-4 py-3 text-gray-600">{{ $req->start_date->format('M d, Y') }}</td>
                                <td class="px-4 py-3 text-gray-600">{{ $req->end_date->format('M d, Y') }}</td>
                                <td class="px-4 py-3 text-gray-600">{{ $req->total_days }}</td>
                                <td class="px-4 py-3 text-gray-600 max-w-[200px] truncate">{{ $req->reason }}</td>
                                <td class="px-4 py-3">
                                    @php

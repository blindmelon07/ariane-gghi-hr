...
$classes = ($active ?? false)
            ...
            : 'inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:text-gray-200 hover:border-gray-300 dark:border-gray-600 focus:outline-none focus:text-gray-700 dark:text-gray-200 focus:border-gray-300 dark:border-gray-600 transition duration-150 ease-in-out';
@endphp
